	...
	<div style="margin:0 auto;">
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				$result_count = mysqli_query($con, "SELECT COUNT(*) As total_records FROM t_gl_bluetooth_employee_master JOIN t_gl_bluetooth_user_master ON t_gl_bluetooth_employee_master.emp_id=
				t_gl_bluetooth_user_master.emp_id WHERE t_gl_bluetooth_user_master.emp_role='user'");
				$total_records = mysqli_fetch_array($result_count);
				$total_records = $total_records['total_records'];
				$total_no_of_pages = ceil($total_records / $total_records_per_page);
				$second_last = $total_no_of_pages - 1; // total page minus 1

				$result = mysqli_query($con, "SELECT *  FROM t_gl_bluetooth_employee_master JOIN t_gl_bluetooth_user_master ON t_gl_bluetooth_employee_master.emp_id=
				t_gl_bluetooth_user_master.emp_id WHERE t_gl_bluetooth_user_master.emp_role='user' ORDER BY t_gl_bluetooth_employee_master.emp_id DESC LIMIT $offset, $total_records_per_page");
